 ...
 * @author pablo
 */
public class ModuloReservaUI extends javax.swing.JFrame {

    /**
     * Creates new form ModuloReservaUI
     */
    public ModuloReservaUI() {
        initComponents();
        cerrar();
    ...
    private void initComponents() {
        ...
        jButton2.setText("Listado de Reservas");
        ...
        jLabel1.setText("Modulo Reservas");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_task_planning_40px.png"))); // NOI18N

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/icons8_business_report_40px_1.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ListadoReservasUI a = new ListadoReservasUI(); 
        a.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModuloReservaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModuloReservaUI().setVisible(true);
            }
        });
    }
